	<?php
/*
Template Name: RAMA - One Page Parallax
...
$dzEmailTo 		= "demo@gmail.com";   /* Receiver Email Address */
$dzEmailFrom    = "RAMA Contact";
...
try {
    if (!empty($_POST)) {
		...
		if($_POST['dzToDo'] == 'Contact')
		{
			...
			$dzMailSubject = 'RAMA|Contact Form: A Person want to contact';
			$dzMailMessage	= 	"
		...
		if($_POST['dzToDo'] == 'Appointment')
		{
			...
			$dzMailSubject = 'RAMA|Appointment Form: A Person want to contact';
			$dzMailMessage	= 	"
								A person want to contact you: <br><br>
								Name: $dzName<br/>
								Email: $dzEmail<br/>
