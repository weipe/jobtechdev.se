...
![Chapter page](/doc/pages/images/pages-chapter.png?width=50pc)
...
![Default page](/doc/pages/images/pages-default.png?width=50pc)
...
**Hugo-theme-learn** provides [archetypes]({{< relref "doc/archetypes.en.md" >}}) to help you create this kind of pages.
...
![Title with icon](/doc/pages/images/frontmatter-icon.png)
