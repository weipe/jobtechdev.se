...
![Page Chapitre](/doc/pages/images/pages-chapter.png?width=50pc)
...
![Page défaut](/doc/pages/images/pages-default.png?width=50pc)
...
**Hugo-theme-learn** fournit des [archétypes]({{< relref "doc/archetypes.fr.md" >}}) pour vous aider à créer ce type de pages.
...
![Titre avec icône](/doc/pages/images/frontmatter-icon.png)
